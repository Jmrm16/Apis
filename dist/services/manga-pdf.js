...
function findBrowserExecutablePath() {
    ...
    throw new ApiError('No se encontro un navegador compatible para generar el PDF. Configura BROWSER_EXECUTABLE_PATH.', 500);
}
...
async function fetchImageAsDataUrl(url, referer, signal) {
...
async function renderPdfPage(page, dataUrl) {
...
<html>
  ...
  <body>
    ...
    const dimensions = await page.evaluate(async (src) => {
        const image = document.getElementById('reader-page');
        if (!image) {
