...
function toNativeSupport(definition) {
    return {
...
function matchDefinition(haystack, definitions) {
...
export function resolveMihonNativeSupport(item) {
...
export function buildMihonNativeFamilySummary(items) {
